...
// Cấu hình Supabase (Dùng URL & Key của bạn)
...
// Danh sách các bảng cần xuất file JSON giống hệt ảnh chụp
const TABLES = [
    'archive_records',
    'audit_logs',
    'bienban_records',
...
// Hàm tải toàn bộ dữ liệu của 1 bảng (tự động phân trang 1000 dòng/lần)
