...
import { getNormalizedWard, OTHER_RECORD_TYPES } from '../constants';
...
import { calculateNextRecordCode } from '../utils/codeGenerator';
...
const calculateNextCodeForConvert = (
    ...
    return calculateNextRecordCode(wardName, dateStr, allRecords, tempCodes, recordType);
};
...
const QuickRecordTypeConverterModal: React.FC<QuickRecordTypeConverterModalProps> = ({
    ...
    const measurementRecords = useMemo(() => {
        return records.filter(r => {
            ...
            return t && !(OTHER_RECORD_TYPES as readonly string[]).includes(t);
        });
    }, [records]);
