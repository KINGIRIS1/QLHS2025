        ...
        if (templateType === 'mau01') {
            ...
            <div style="font-family: 'Times New Roman', serif; font-size: 13pt; line-height: 1.3; color: black; text-align: justify; width: 100%;">
                ...
                <div style="margin-left: 20px;">
                    <p>1. Ông/bà: ${creatorName} - Chức vụ: Nhân viên Văn phòng Đăng ký đất đai thành phố Đồng Nai - Chi nhánh Chơn Thành – Phụ trách tiếp nhận hồ sơ lĩnh vực đất đai tại Trung tâm phục vụ hành chính công ${data.XA_PHUONG}.</p>
                </div>
